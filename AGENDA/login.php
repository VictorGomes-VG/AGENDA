...
<div class="container" style="margin: 30px auto;border-radius: 10px; background-color: black; padding: 50px; width: 1000px">
    <!-- LOGIN-->
    <form class="form-horizontal" action="controlador_agenda.php?acao=login" method="post">
        <fieldset>
            ...
            <div class="form-group">
                <label class="col-md-4 control-label" for="login" style="color: white">Login</label>
                <div class="col-md-4">
            ...
            <!-- Password input-->
            <div class="form-group">
                <label class="col-md-4 control-label" for="senha" style="color: white">Senha</label>
                <div class="col-md-4">
