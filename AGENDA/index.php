...
<div class="container" style="margin-top: 30px; margin-bottom: 30px; border-radius: 10px; background-color: #000; color: #ffffff;">
    ...
    <a href="controlador_agenda.php?acao=logout" class="btn btn-danger" style="border-radius: 50%;float: right; margin: 10px">X</a>
        ...
        <div class="col-md-12">
            <form class="form-inline" action="controlador_agenda.php?acao=cadastrarContatos" method="post">
                ...
                <div class="form-group col-md-1">
                    <button type="submit" class="btn btn-success form-group" style="">CADASTRAR</button>
                </div>
            </form>
        </div>
    </div>
            ...
            <table class="table">
                ...
                <?php foreach ($meusContatos as $cont): ?>
                    <tr>
                        ...
                        <td>            <?= $cont['email']    ?></td>
                        <td>            <?= $cont['telefone'] ?></td>
                        <td><a type="button" class="btn btn-warning" href="editar.php?acao=editar&id=<?= $cont['id'] ?>">X</a></td>
